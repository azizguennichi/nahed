  ...
  return (
    ...
    <form onSubmit={loginSubmit}>
        ...
        <div className="user-box">
            ...
            <input id="password-input" type="password" name="password"  value={user.password}  required onChange={onChangeInput}/>
            <button id="toggle-password-button" type="button" onClick={passwordVisibilityHandler}>Afficher</button>
